...
__all__ = ['PASSING_STATUS', 'FAILING_STATUS', 'Validate', 'validate', 'listify', 'ValidateRecord']
...
class ValidateRecord:
    ...
    BASIC_PROPERTIES = ['name', 'version', 'contributors', 'created_at', 'updated_at']
    REQUIRED_MAP = dict(
